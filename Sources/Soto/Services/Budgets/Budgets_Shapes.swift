...
extension Budgets {
    ...
    public struct ActionThreshold: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.actionThresholdValue, name: "actionThresholdValue", parent: name, max: 40000000000.0)
    ...
    public struct Notification: AWSEncodableShape & AWSDecodableShape {
        ...
        public func validate(name: String) throws {
            try self.validate(self.threshold, name: "threshold", parent: name, max: 40000000000.0)
